...
def main(args):
    ...
    with open(save_path + '/train_val_metrics.txt', 'w') as file:
        ...
        for epoch in range(epochs):
            ...
            scheduler.step(train_loss)  # Use training loss to adjust learning rate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./Our/Case1/Train_01/lr_0.006/last_epoch.pth')
    parser.add_argument('--save_path', type=str, default="./Our/Binary/Train_03/")
