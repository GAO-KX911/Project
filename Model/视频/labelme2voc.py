...
def main():
    base_dir = "/home/mayi/wd/wxz/ObjectDetectionData"          #"D:/fire_smoke"   # 修改为当前数据所在的根目录
    input_dir = "/home/mayi/wd/wxz/ObjectDetectionData/fire_smoke_label"   #"D:/fire_smoke/json"  # 修改为 LabelMe 标注文件json所在的文件夹路径
    output_dir = "/home/mayi/wd/wxz/ObjectDetectionData/fire_smoke_voc"  #"D:/fire_smoke_voc"   # 修改为 VOC 格式输出的文件夹路径
