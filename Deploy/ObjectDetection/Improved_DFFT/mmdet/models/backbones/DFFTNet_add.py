...
# def template_match(template_images, filename_list, th, tw, threshold=0.65):  # kaggle不行
def template_match(template_images, filename_list, th, tw, threshold=0.75): # 新模板
...
class DFFTNet_add(nn.Module):
    ...
    def forward(self, x, filename_list):
        ...
        dot_feature[0] = temp + dot_feature[0]
    ...
    def train(self, mode=True):
        ...
        super(DFFTNet_add, self).train(mode)
        self._freeze_stages()
# 
